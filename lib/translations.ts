...
export const translations = {
    en: {
        ...
        form: {
            ...
            limit_reached: "Sorry, we have reached the limit of participants.",
            loading_form: "Loading form...",
            status_closed_title: "Registration Closed",
            status_closed_msg: "The limit has been reached or registrations are temporarily closed.",
            status_expired_title: "Event Ended",
            status_expired_msg: "This event has already passed. Stay tuned for future editions!",
            status_full_title: "Sold Out",
            status_full_msg: "Unfortunately, we have reached the maximum capacity for this session.",
            status_unavailable_title: "Unavailable",
            status_unavailable_msg: "Registrations are currently suspended. Please try again later.",
            status_soon_title: "Coming Soon",
            status_soon_msg: "No active events for registration yet. Stay tuned!",
            status_footer: "Follow our socials for updates"
        },
        curriculum: {
            pill: "The Curriculum",
        ...
        backoffice: {
            portal_title: "Backoffice Portal",
            tab_leads: "Registrants",
            tab_events: "Events",
            tab_assets: "Flyers & Design",
            tab_content: "Site Content",
            btn_exit: "Exit Dashboard",
            filter_all: "All Events",
            leads_title: "Confirmed Registrants",
            leads_filter_placeholder: "Filter...",
            th_name: "Name",
            th_contact: "Email / Tel",
            th_status: "Status",
            th_actions: "Actions",
            status_approved: "✓ Approved",
            status_pending: "Pending",
            events_title: "Manage Events",
            btn_new_event: "Create New Event",
            event_registrations: "Registrations",
            event_open: "Open",
            event_closed: "Closed",
            btn_close_reg: "Close Registration",
            btn_open_reg: "Open Registration",
            assets_upload_title: "Flyer Upload",
            assets_dropzone: "Drag or click to select",
            assets_title_placeholder: "Flyer Title",
            assets_desc_placeholder: "Short description...",
            btn_publish_asset: "Publish to Gallery",
            content_masterclass_title: "Masterclass Page",
            btn_publish_content: "Publish Changes",
            content_tag_label: "Tag (Announcement)",
            content_prefix_label: "Title Prefix",
            content_highlight_label: "Title Highlight",
            content_subtitle_label: "Subtitle (Below Title)",
            content_location_label: "Displayed Location",
            content_date_time_label: "Date & Time",
            content_curriculum_title: "Event Curriculum",
            btn_update_pillars: "Update Pillars",
            modal_edit_event: "Edit Event",
            modal_create_event: "Create New Event",
            label_event_title: "Event Title",
            label_event_date: "Event Date",
            label_event_time: "Event Time",
            label_event_location: "Location",
            label_event_slug: "URL Slug",
            label_event_limit: "Registration Limit",
            label_event_desc: "Description (Visible on site)",
            btn_save_changes: "Save Changes",
            btn_cancel: "Cancel",
            auth_title: "Restricted Access",
            auth_password_placeholder: "Master Password",
            auth_btn: "Enter Dashboard",
    ...
    pt: {
        ...
        form: {
            ...
            limit_reached: "Desculpe, atingimos o limite de participantes.",
            loading_form: "Carregando formulário...",
            status_closed_title: "Inscrições Fechadas",
            status_closed_msg: "O limite de vagas foi atingido ou as inscrições foram temporariamente fechadas.",
            status_expired_title: "Evento Encerrado",
            status_expired_msg: "A data deste evento já passou. Fique atento para novas edições!",
            status_full_title: "Vagas Esgotadas",
            status_full_msg: "Infelizmente já atingimos o limite máximo de participantes para esta sessão.",
            status_unavailable_title: "Indisponível",
            status_unavailable_msg: "As inscrições estão suspensas no momento. Tente novamente mais tarde.",
            status_soon_title: "Brevemente",
            status_soon_msg: "Ainda não temos eventos ativos para inscrição. Fique ligado!",
            status_footer: "Acompanhe nossas redes para mais novidades"
        },
        curriculum: {
            pill: "O Currículo",
        ...
        footer: {
            ...
            rights: "© 2026 Marcus Banjo. Todos os Direitos Reservados.",
            tagline: "WealthSprings Accelerator"
        },
        assistant: {
        ...
        backoffice: {
            portal_title: "Portal Backoffice",
            tab_leads: "Inscrições",
            tab_events: "Eventos",
            tab_assets: "Flyers & Design",
            tab_content: "Conteúdo do Site",
            btn_exit: "Sair do Painel",
            filter_all: "Todos os Eventos",
            leads_title: "Candidatos Confirmados",
            leads_filter_placeholder: "Filtrar...",
            th_name: "Nome",
            th_contact: "Email / Tel",
            th_status: "Status",
            th_actions: "Ações",
            ...
            events_title: "Gerenciar Eventos",
            btn_new_event: "Criar Novo Evento",
            event_registrations: "Inscrições",
            event_open: "Aberto",
            event_closed: "Fechado",
            btn_close_reg: "Fechar Inscrições",
            btn_open_reg: "Abrir Inscrições",
            assets_upload_title: "Upload de Flyer",
            assets_dropzone: "Arraste ou clique para selecionar",
            assets_title_placeholder: "Título do Flyer",
            assets_desc_placeholder: "Descrição curta...",
            btn_publish_asset: "Publicar na Galeria",
            content_masterclass_title: "Página Masterclass",
            btn_publish_content: "Publicar Texto",
            content_tag_label: "Chamada (Tag)",
            content_prefix_label: "Título Prefixo",
            content_highlight_label: "Título Destaque",
            content_subtitle_label: "Subtítulo (Abaixo do Título)",
            content_location_label: "Localização Exibida",
            content_date_time_label: "Data & Hora",
            content_curriculum_title: "Currículo do Evento",
            btn_update_pillars: "Atualizar Pilares",
            modal_edit_event: "Editar Evento",
            modal_create_event: "Criar Novo Evento",
            label_event_title: "Título do Evento",
            label_event_date: "Data do Evento",
            label_event_time: "Hora do Evento",
            label_event_location: "Localização",
            label_event_slug: "Slug da URL",
            label_event_limit: "Limite de Inscritos",
            label_event_desc: "Descrição (Visível no site)",
            btn_save_changes: "Guardar Alterações",
            btn_cancel: "Cancelar",
            auth_title: "Acesso Restrito",
            auth_password_placeholder: "Senha Mestra",
            auth_btn: "Entrar no Painel",
